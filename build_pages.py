            ...
            <div class="detail-actions">
                <a href="/?addcart={sku}" class="btn-inquiry" onclick="
                    ...
                    if (!t) {{
                        ...
                        t.id = 'pm-cart-toast';
                        t.style.cssText = 'position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:#4E6A3E;color:#fff;padding:12px 22px;border-radius:24px;font-size:0.9rem;font-weight:600;z-index:9999;box-shadow:0 4px 16px rgba(0,0,0,0.18);display:flex;align-items:center;gap:8px;';
                        t.innerHTML = '&#10003; Added to inquiry cart &mdash; <a href=\"/\" style=\"color:#d4e8c2;text-decoration:underline;\">View Cart &amp; Submit</a>';
                        document.body.appendChild(t);
                    }}
                    t.style.display = 'flex';
                    clearTimeout(window._pmCartToastTimer);
                    window._pmCartToastTimer = setTimeout(function(){{ t.style.display='none'; }}, 5000);
