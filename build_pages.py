    ...
    <div class="detail-layout">
        ...
        <div class="detail-info">
            ...
            <div class="detail-actions">
                <a href="/?addcart={sku}" class="btn-inquiry" onclick="
                    event.preventDefault();
                    try {{
                        localStorage.setItem('pm_addcart','{sku}');
                    }} catch(e) {{}}
                    var t = document.getElementById('pm-cart-toast');
                    if (!t) {{
                        t = document.createElement('div');
                        t.id = 'pm-cart-toast';
                        t.style.cssText = 'position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:#4E6A3E;color:#fff;padding:14px 22px;border-radius:24px;font-size:0.88rem;font-weight:600;z-index:9999;box-shadow:0 4px 16px rgba(0,0,0,0.22);display:flex;align-items:center;gap:10px;white-space:nowrap;';
                        t.innerHTML = '&#10003; Added 120 pcs to cart &nbsp;&mdash;&nbsp; <a href=\"/?addcart={sku}\" style=\"color:#d4e8c2;text-decoration:underline;font-weight:700;\">View Cart &amp; Submit Inquiry &rarr;</a>';
                        document.body.appendChild(t);
                    }} else {{
                        t.innerHTML = '&#10003; Added 120 pcs to cart &nbsp;&mdash;&nbsp; <a href=\"/?addcart={sku}\" style=\"color:#d4e8c2;text-decoration:underline;font-weight:700;\">View Cart &amp; Submit Inquiry &rarr;</a>';
                    }}
                    t.style.display = 'flex';
                    clearTimeout(window._pmCartToastTimer);
                    window._pmCartToastTimer = setTimeout(function(){{ t.style.display='none'; }}, 7000);
                ">&#128722; Inquire This Product</a>
